...
- HTML, and the URL's **last path segment ends in `.pdf`** (e.g. scispace `/pdf/<slug>.pdf`) → a bot-protection **challenge served instead of the file**. Report it as a blocked PDF and skip; do not ingest the challenge page as a web page.
