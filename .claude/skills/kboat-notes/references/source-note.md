...
A partial pass discards nothing for the same reason: the claims of a concept it left unwritten have landed nowhere else, and the notebook is their only grounding.
