...
- Errors: each collected error with the item it affected and the cause (e.g. bot-blocked fetch, rate-limited `create`/`source add`, note write failure, slug collision).
