...
- Read the body, re-judge genuine relevance from it (demote or drop a candidate the summary oversold; confirm one that truly delivers), and record its length (the character count).
