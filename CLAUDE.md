...
- A ripe source's notebook is discarded last, and not at all by a pass that left a concept unwritten, so neither a crash nor a partial pass loses an undistilled reading.
