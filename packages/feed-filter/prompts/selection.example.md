...
This file is the keep/drop prompt each judging subagent reads before it judges.
...
When judging a **forum candidate** (from the `kboat-forum-run` skill), two rules apply.
