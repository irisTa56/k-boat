...
The library surface — its eight console scripts and four shared modules (`kboat.frontmatter`, `kboat.schema`, `kboat.write`, `kboat.cli`) — is described in [README.md](README.md).
